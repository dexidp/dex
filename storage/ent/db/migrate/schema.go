...
var (
	...
	AuthSessionsColumns = []*schema.Column{
		...
		{Name: "logout_state", Type: field.TypeBytes, Nullable: true},
	}
	...
	Oauth2clientsColumns = []*schema.Column{
		...
		{Name: "dynamically_registered", Type: field.TypeBool, Default: false},
		{Name: "grant_types", Type: field.TypeJSON, Nullable: true},
		{Name: "response_types", Type: field.TypeJSON, Nullable: true},
		{Name: "allowed_scopes", Type: field.TypeJSON, Nullable: true},
		{Name: "token_endpoint_auth_method", Type: field.TypeString, Nullable: true, Size: 2147483647, Default: "", SchemaType: map[string]string{"mysql": "varchar(384)", "postgres": "text", "sqlite3": "text"}},
		{Name: "registration_time", Type: field.TypeInt64, Default: 0},
		{Name: "registration_token_id", Type: field.TypeString, Nullable: true, Size: 2147483647, Default: "", SchemaType: map[string]string{"mysql": "varchar(384)", "postgres": "text", "sqlite3": "text"}},
		{Name: "registration_expires_at", Type: field.TypeInt64, Default: 0},
