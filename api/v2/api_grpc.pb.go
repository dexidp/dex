...
const (
	Dex_GetExpiration_FullMethodName    = "/api.Dex/GetExpiration"
	Dex_UpdateExpiration_FullMethodName = "/api.Dex/UpdateExpiration"
...
type DexClient interface {
	// GetExpiration gets TODO.
	GetExpiration(ctx context.Context, in *GetExpirationReq, opts ...grpc.CallOption) (*GetExpirationResp, error)
	// UpdateExpiration updates TODO.
	UpdateExpiration(ctx context.Context, in *UpdateExpirationReq, opts ...grpc.CallOption) (*UpdateExpirationResp, error)
...
func (c *dexClient) GetExpiration(ctx context.Context, in *GetExpirationReq, opts ...grpc.CallOption) (*GetExpirationResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetExpirationResp)
	err := c.cc.Invoke(ctx, Dex_GetExpiration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dexClient) UpdateExpiration(ctx context.Context, in *UpdateExpirationReq, opts ...grpc.CallOption) (*UpdateExpirationResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateExpirationResp)
	err := c.cc.Invoke(ctx, Dex_UpdateExpiration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DexServer interface {
	// GetExpiration gets TODO.
	GetExpiration(context.Context, *GetExpirationReq) (*GetExpirationResp, error)
	// UpdateExpiration updates TODO.
	UpdateExpiration(context.Context, *UpdateExpirationReq) (*UpdateExpirationResp, error)
	// GetClient gets a client.
...
func (UnimplementedDexServer) GetExpiration(context.Context, *GetExpirationReq) (*GetExpirationResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetExpiration not implemented")
}
func (UnimplementedDexServer) UpdateExpiration(context.Context, *UpdateExpirationReq) (*UpdateExpirationResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateExpiration not implemented")
}
...
func _Dex_GetExpiration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetExpirationReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DexServer).GetExpiration(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Dex_GetExpiration_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DexServer).GetExpiration(ctx, req.(*GetExpirationReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Dex_UpdateExpiration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateExpirationReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DexServer).UpdateExpiration(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Dex_UpdateExpiration_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DexServer).UpdateExpiration(ctx, req.(*UpdateExpirationReq))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Dex_GetExpiration_Handler,
		},
		{
			MethodName: "UpdateExpiration",
			Handler:    _Dex_UpdateExpiration_Handler,
		},
		{
