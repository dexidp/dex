...
import (
	...
	"github.com/dexidp/dex/connector/external"
...
var ConnectorsConfig = map[string]func() ConnectorConfig{
	...
	// External connectors
	"externalPassword": func() ConnectorConfig { return new(external.PasswordConnectorConfig) },
	"externalCallback": func() ConnectorConfig { return new(external.CallbackConnectorConfig) },
}
