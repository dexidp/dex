...
func (c *ldapConnector) userEntry(conn *ldap.Conn, username string) (user ldap.Entry, found bool, err error) {
	...
	case 0:
		...
		return ldap.Entry{}, false, fmt.Errorf("ldap: no results returned for filter: %q LDAP Result Code %d %q: ", filter, ldap.LDAPResultNoSuchObject, ldap.LDAPResultCodeMap[ldap.LDAPResultNoSuchObject])
	case 1:
		user = *resp.Entries[0]
